...
void Main()
{
	...
	MyExtensions.AreEqual(0, PositionOfSetDigit2(1));
	MyExtensions.AreEqual(1, PositionOfSetDigit2(2));
	MyExtensions.AreEqual(2, PositionOfSetDigit2(4));
	MyExtensions.AreEqual(3, PositionOfSetDigit2(8));
}
...
{
	if ((x & x - 1) != 0)
		throw new ArgumentException($"{x} has more than single 1");
