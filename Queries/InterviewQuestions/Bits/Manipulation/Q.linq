...
void Main()
{
	...
	MyExtensions.AreEqual<sbyte>(unchecked((sbyte)0b11100111), MaskSix(3,5));
...
public static sbyte MaskThree(int n) => throw new NotImplementedException();

// Question: 
//		Implement this function to return a mask of all
// 		zeroes except for ones in the n least significant bits
public static sbyte MaskFour(int n) => throw new NotImplementedException();
